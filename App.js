...
export default class App extends React.Component {
  ...
  renderTest() {
    ...
    // 充值   yes
    // chargeToken(config.userAddr2, 100, config.marketableTokenAddr, 
    ...
    //   createSubTopic("0x4694e8f80f878e15cef6ecd0477a1546884eb369309999a111fd707169e05312", 
    //     "Nihao ", config.userAddr2, config.pwd, keystore_myTest, config.subChainAddr, config.rpcIp).then((data) => {
    //     console.log(data);
    //   });
    ...
    //       "0x3768294a3ae2803b0b691986962e5dfd6696c80678a20bb7b0a1c589d12c2253", config.subChainAddr,
   ...
   //removeItem("3333")
    ...
    // getSubTopicList("0x4694e8f80f878e15cef6ecd0477a1546884eb369309999a111fd707169e05312",
